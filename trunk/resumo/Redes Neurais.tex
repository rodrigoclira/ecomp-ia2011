...
Redes Neurais Artificiais é uma técnica no qual basea-se no funcionamento do sistema nervoso humano. Esse sistema é formado por uma série de neurônios no qual se comunicam através de impulso nervosos, quando um impulso é recebido, o neurônio o processa, e passando de um limite de ação dispara um segundo impulso que produz uma substância neurotrasmissora o qual flui 
do corpo celular para o axônio. Baseando-se nesse comportamento dos neurônios naturais Hebb criou a lei que rege as Redes Neurais Artificias: ``Quando um neurônio recebe um estímulo de outro neurônio, e se ambos estão altamente ativos, o peso entre estes deve ser fortalecido, caso contrário enfraquecido``. 

Neste trabalho foi demostrado as diferenças entre as três principais Redes Neurais Artificiais e as suas implementações. Foram vistas as Redes Neurais Artificiais Perceptron, 
Adaline, e MLP (Multi-Layer Perceptron). Para total entendimento foram explicados a regra delta e o cálculo do erro quadrático. Ao longo do trabalo foi visto que as duas primeiras técnicas demostradas possuem limitações na qual impossibilita as suas aplicações em problema do tipo linearmente não-separáveis. 

\section{Referências}
\begin{itemize}
 \item Mêuser Valença. 'Fundamentos das Redes Neurais'. 2010
 \item Leandro Oliveira Araujo, Heder Saito Nunes, Celso Correia de Souza, José Francisco dos Reis Neto. 'Utilização de Redes Neurais Artificiais como ferramenta para aproximação de função.' 
 \item Redes Neurais. site:http://www.din.uem.br/ia/neurais/
 \item Redes Neurais Artificiais. site:http://www.infowester.com/redesneurais.php
 \item Jorge M. Barreto 'Indrodução Redes Neurais Artificiais'. site:www.inf.ufsc.br/~barreto/tutoriais/Survey.pdf+Redes+Neurais
\end{itemize}
